...
use App\Policies\ProviderDocumentPolicy;
use App\Policies\ReferralBonusPolicy;
...
use App\Policies\WalletBonusPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        UserDocument::class => ProviderDocumentPolicy::class,
        ReferralBonus::class => ReferralBonusPolicy::class,
        WalletBonus::class => WalletBonusPolicy::class,
        SeoSettings::class => SeoSettingPolicy::class
    ];
