...
return [
  ...
  "enableToFeature"=>"Enable to feature this service on the User app home screen. Disable to remove it.",
  ...
  "uploadVideoLink" => "Upload Video Link",
  "videoLink" => "Video Link",
  "pleaseEnterVideoLink" => "Please Enter Video Link",
  "selectDate" => "Select Date",
  "pleaseCheckYourWalletBalance" => "Please Check Your Wallet Balance",
  "categoryScreenPricePerImage" => "Category screen price per image",
  "categoryScreenPricePerVideo" => "Category screen price per Video",
  "totalNoOfImage" => "Total no of Image",
  "totalNoOfVideo" => "Total no of Video",
  "totalNoOfService" => "Total no of Service",
  "totalNoOfDays" => "Total no of days",
  "availableBalanceInWallet" => "Available Balance in wallet",
  "addServiceAddOns" => "Add Add-ons",
  "serviceAddons"=>"Service Add-ons",
  "percentageCannotBeMoreThan100" => "Percentage cannot be more than 100",
  "customerUsedCoins" => "Customer used coins to get a discount on this booking.",
  "optional" => "Optional",
  "updateCompanyDetails" => "Please update your company details to create service",
  "verifyAccountToCreateService" => "Please verify your account to create service",
];
