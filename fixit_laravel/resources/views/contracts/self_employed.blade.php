...
{{-- TODO: вставить текст разделов из contract_self_employed.docx --}}
{{-- Разделы: 1. Предмет договора; 2. Права и обязанности сторон; 3. Порядок оказания услуг;
     4. Стоимость и порядок расчётов; 5. Ответственность сторон; 6. Конфиденциальность;
     7. Срок действия договора; 8. Заключительные положения --}}
