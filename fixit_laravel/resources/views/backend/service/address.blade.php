        ...
        <div class="modal-content">
            <form action="{{ route('backend.address.store') }}" id="addressForm" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-gray btn-md" data-bs-dismiss="modal">{{ __('static.custom_sms_gateways.close') }}</button>
                    <button type="submit" class="btn btn-primary">{{ __('static.submit') }}</button>
                </div>
            </form>
        </div>
    </div>
