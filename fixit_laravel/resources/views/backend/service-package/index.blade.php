...
@section('content')
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="btn-action">
                        ...
                        <button type="button" class="btn btn-outline-primary import-redirect-btn" data-url="{{ route('backend.import-export.index', 'service-packages') }}">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="servicepackageFilterForm">
    ...
    <form id="exportForm" method="GET" action="{{ route('backend.service-package.data.export') }}">
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $('#reset').click(function () {
                    $('#servicepackageFilterForm').trigger('reset'); ;
