...
class DefaultCreationLimits {
  ...
  String? maxBookingDays;
  String? maxAdvertisementDays;
  ...
  DefaultCreationLimits.fromJson(Map<String, dynamic> json) {
    ...
    maxBookingDays = json['max_booking_days'];
    maxAdvertisementDays = json['max_advertisement_days'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['max_booking_days'] = maxBookingDays;
    data['max_advertisement_days'] = maxAdvertisementDays;
    return data;
  }
}
...
class FirebaseCred {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['yandex_map_api_key'] = yandexMapApiKey;
    return data;
  }
}
